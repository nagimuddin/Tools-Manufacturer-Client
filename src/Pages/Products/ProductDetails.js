...
const ProductDetails = () => {
    ...
    useEffect(() => {
        async function fetchData() {
            const res = await fetch(`https://tools-manufactur.herokuapp.com/tools/${id}`);
    ...
    const onSubmit = e => {
        ...
        if (quantity > available) {
            ...
            if (confirm) {
                ...
                fetch('https://tools-manufactur.herokuapp.com/orders', {
                    method: 'POST',
                    headers: {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            fetch(`https://tools-manufactur.herokuapp.com/tools/${id}`, {
                                method: 'PUT',
                                headers: {
                                    'content-type': 'application/json',
                                    authorization: `Bearer ${localStorage.getItem('accessToken')}`
