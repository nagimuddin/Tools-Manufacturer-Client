...
const MakeAdmin = () => {
    const { data: users, isLoading, refetch } = useQuery('users', () => fetch('https://tools-manufactur.herokuapp.com/all-users', {
        method: 'GET',
        headers: {
    ...
    const makeAdmin = (email) => {
        ...
        fetch(`https://tools-manufactur.herokuapp.com/user-update/${email}`, {
            method: 'PUT',
            headers: {
                authorization: `Bearer ${localStorage.getItem('accessToken')}`
            }
