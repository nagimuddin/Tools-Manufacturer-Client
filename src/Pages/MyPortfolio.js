                        ...
                        <div className="flex flex-col sm:flex-row mt-10">
                            <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                                <div className="w-20 h-20 rounded-full inline-flex items-center justify-center bg-gray-200 text-gray-400">
                                    <img src='https://buthydro.sirv.com/Tools%20images/my_photo.png' alt="" />
                                </div>
                                <div className="flex flex-col items-center text-center justify-center">
                                    <h2 className="font-medium title-font mt-4 text-gray-900 text-lg">Nagim Uddin</h2>
                                    <div className="w-12 h-1 bg-indigo-500 rounded mt-2 mb-4"></div>
                                    <ul className='flex gap-3 py-2'>
                                        <li><Link to='https://github.com/nagimuddin'>Github</Link></li>
                                    </ul>
                            ...
                            <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                                <p className="leading-relaxed text-lg mb-4">Hi, My Name Is Nagim Uddin. I didn't know anything when I started my journey. And web development is not so popular in my district still now. So I had to suffer a lot.</p>
